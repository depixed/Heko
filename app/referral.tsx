...
export default function ReferralScreen() {
  ...
  useLayoutEffect(() => {
    const showButton = user && (!user.referredBy || user.referredBy === null || user.referredBy === undefined || user.referredBy === '');
    console.log('[Referral] useLayoutEffect - Updating header:', {
      userId: user?.id,
      ...
      <View style={styles.container}>
        <Stack.Screen
          options={{
            ...
            headerRight: () => {
              const showButton = user && (!user.referredBy || user.referredBy === null || user.referredBy === undefined || user.referredBy === '');
              console.log('[Referral] HeaderRight render - showButton:', showButton, 'user.referredBy:', user?.referredBy);
              return (
                <View style={styles.headerRightContainer}>
                  {showButton && (
                    <TouchableOpacity onPress={handleOpenAddReferrerModal} style={styles.headerButton}>
